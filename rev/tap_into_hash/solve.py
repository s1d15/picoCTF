...
for i in range(0, len(enc), block_size):
    ...
    plaintext_block = bytes(a ^ b for a, b in zip(block, key_hash))
    plaintext += plaintext_block

flag = plaintext[162:220].decode()
